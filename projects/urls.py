...
urlpatterns = [
    ...
    path('storyboard/note/edit', views.project_storyboard_edit_note, name='projects-storyboard-edit-note'),
    path('storyboard/note/cancel-edit', views.project_storyboard_cancel_edit_note, name='projects-storyboard-cancel-edit-note'),
